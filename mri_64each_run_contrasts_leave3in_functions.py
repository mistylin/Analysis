...
Why? In previous analysis, we indeed average betas across voxels.
But after double thinking, I assume we need the leave-one-run-out procedure, 
1. find the preferred locaiton based on all runs
2. center the matrix to a specific locaiton
3. average betas across 3 runs, get a beta matrix per voxel
4. average betas across voxels
